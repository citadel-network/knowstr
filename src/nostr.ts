...
export const DEFAULT_RELAYS: Relays = [
  ...
  { url: "wss://relay.nostrss.re", read: true, write: true },
  { url: "wss://at.nostrworks.com", read: true, write: true },
  { url: "wss://btc.klendazu.com", read: true, write: true },
  { url: "wss://deschooling.us", read: true, write: true },
  { url: "wss://knostr.neutrine.com", read: true, write: true },
  ...
  { url: "wss://nostr.einundzwanzig.space", read: true, write: true },
  { url: "wss://nostr.fmt.wiz.biz", read: true, write: true },
  { url: "wss://nostrich.friendship.tw", read: true, write: true },
  { url: "wss://nostr.mom", read: true, write: true },
  { url: "wss://nostr.nodeofsven.com", read: true, write: true },
  { url: "wss://nostr.noones.com", read: true, write: true },
  { url: "wss://nostr.oxtr.dev", read: true, write: true },
  { url: "wss://nostr.pobblelabs.org", read: true, write: true },
  { url: "wss://nostr-pub.semisol.dev", read: true, write: true },
  { url: "wss://nostr-pub.wellorder.net", read: true, write: true },
  { url: "wss://nostrrelay.com", read: true, write: true },
  { url: "wss://nostr.shawnyeager.net", read: true, write: true },
  { url: "wss://nostr.lopp.social", read: true, write: true },
  { url: "wss://relay.wellorder.net", read: true, write: true },
];
